## meta
- project_id: authonom-health-lyon
- project_slug: authonom-health-lyon
- primary_color: #1850c0
- secondary_color: #0d9488
- status: active
- favicon: data/Logoahealth.png
- external_url: https://pepr-santenum.fr/2023/11/07/autonom-health/
...
**how:** This project will rely on population-based interventions in existing numeric cohorts (KANOPEE) where virtual agents interact with patients at home on a regular basis. Pilot hospital departments will also be involved for data management supervised by information and decision systems coordinating autonomous digital Cognitive Behavioral interventions based on our SIA (Socially Interactive Agents). The global solution based on empathic Human-Computer Interactions will help targeting, diagnose and treat subjects suffering from dysfunctional behavioral issues. The expected benefits include increased adherence to treatment, strong self-empowerment to improve autonomy and a reduction of long-term risks for subjects and patients.
